...
export default function Hero() {
	return (<div className='margin'> <div className="grid gap-12 mx-auto mb-24 max-w-screen-xl text-left lg:my-20 lg:gap-20 xl:items-center xl:mb-24 xl:grid-cols-5 sm:mb-10 md:grid-cols-2"> <div className="order-2 col-span-1 text-gray-700 xl:col-span-2 md:order-1"> <h2 className="m-0 max-w-xl text-2xl leading-8 text-gray-900 font-bold sm:text-3xl sm:leading-9 md:text-4xl md:leading-10 lg:font-bold lg:text-4xl xl:text-5xl "> Finest Products </h2> <p className="flex mx-0 mt-6 mb-0 max-w-xl text-lg leading-relaxed xl:leading-7"> <span className="flex items-center text-gray-500 text-sm gap-1"> <svg className="w-6 h-6 text-green-500"
