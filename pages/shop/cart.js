...
const Cart = ({ context }) => {
  ...
  return (
    <>
      <Head>
        <title>Jalabiya ECommerce - Cart</title>
        <meta name="description" content={`Jalabiya ECommerce - Shopping cart`} />
        <meta property="og:title" content="Jalabiya ECommerce - Cart" key="title" />
      </Head>
      <Navbar />
